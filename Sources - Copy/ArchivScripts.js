import { getDBStatus, getDBRunning, getStates, getTopHeadlines, getTopicHeadlinesInfo, getTopicItems, getInitValues, getInfoLabels, getFrontPageFiles, getOutputText } from "./HTTPRequests.js";
...
//window.electronAPI.getHttpPort((value) => {   // receive the http port from Electron (main.js). Cannot be syncronisized
//    localStorage.setItem("httpPort", value);
//    console.log(value);
//});

//window.electronAPI.sendHttpPort();  // request the port from main.js (init.json)

//console.log(localStorage.getItem("httpPort"));

//if (localStorage.getItem("httpPort") == null) {
//    localStorage.setItem("httpPort", "8088");
//}
